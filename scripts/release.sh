...
: "${MENU_SIGNING_PASSWORD:?set MENU_SIGNING_PASSWORD, e.g. \$(op read \"op://Private/Menu signing key/password\")}"
...
# MENU_SIGNING_PASSWORD keeps reporting "keystore password was incorrect"
